...
public class SyntaxPreferences implements Serializable{
	...
	private static final long serialVersionUID = -6609571990739116454L;
...
//	private transient PropertyChangeReporter _propChgReporter;
	...
	/**
	 * If <TT>true</TT> use the Oster text control else use the standard Java
	 * control.
	 */
...
//	private boolean _usePlainTextControl = false;
	...
	public SyntaxPreferences() {
		...
		_reservedWordStyle.setBold(true);
...
//					IPropertyNames.USE_OSTER_CONTROL, _useOsterTextControl,
//					data);
...
//			getPropertyChangeReporter().firePropertyChange(
//					IPropertyNames.USE_NETBEANS_CONTROL,
...
//			getPropertyChangeReporter().firePropertyChange(
//					IPropertyNames.USE_PLAIN_CONTROL, _usePlainTextControl,
//					data);
...
//			_commentStyle = data;
//			getPropertyChangeReporter().firePropertyChange(
//					IPropertyNames.COMMENT_STYLE, oldValue, _commentStyle);
//		}
//	}
...
//			_dataTypeStyle = data;
//			getPropertyChangeReporter().firePropertyChange(
//					IPropertyNames.DATA_TYPE_STYLE, oldValue, _dataTypeStyle);
//		}
//	}
...
//			_errorStyle = data;
//			getPropertyChangeReporter().firePropertyChange(
//					IPropertyNames.ERROR_STYLE, oldValue, _errorStyle);
//		}
//	}
...
//			_functionStyle = data;
//			getPropertyChangeReporter().firePropertyChange(
//					IPropertyNames.FUNCTION_STYLE, oldValue, _functionStyle);
//		}
//	}
...
//					.firePropertyChange(IPropertyNames.IDENTIFIER_STYLE,
...
//			_literalStyle = data;
//			getPropertyChangeReporter().firePropertyChange(
//					IPropertyNames.LITERAL_STYLE, oldValue, _literalStyle);
//		}
//	}
...
//			_tableStyle = data;
//			getPropertyChangeReporter().firePropertyChange(
//					IPropertyNames.TABLE_STYLE, oldValue, _tableStyle);
//		}
//	}
...
//			_columnStyle = data;
//			getPropertyChangeReporter().firePropertyChange(
//					IPropertyNames.COLUMN_STYLE, oldValue, _columnStyle);
//		}
//	}
...
//			_operatorStyle = data;
//			getPropertyChangeReporter().firePropertyChange(
//					IPropertyNames.OPERATOR_STYLE, oldValue, _operatorStyle);
//		}
//	}
...
//			getPropertyChangeReporter().firePropertyChange(
//					IPropertyNames.RESERVED_WORD_STYLE, oldValue,
//					_reservedWordStyle);
//		}
//	}
...
//			getPropertyChangeReporter().firePropertyChange(
//					IPropertyNames.SEPARATOR_STYLE, oldValue, _separatorStyle);
//		}
//	}
...
//			getPropertyChangeReporter().firePropertyChange(
//					IPropertyNames.WHITE_SPACE_STYLE, oldValue,
//					_whiteSpaceStyle);
//		}
//	}
