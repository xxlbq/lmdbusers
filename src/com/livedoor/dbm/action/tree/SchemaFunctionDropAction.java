...
public class SchemaFunctionDropAction extends DBMBaseAction {

	public SchemaFunctionDropAction() {
		super("SCHEMA_FUNCTION_DROP");
		// TODO 自动生成构造函数存根
	}

	@Override
	public void processAction(DBMFrame frame, ActionEvent actionEvent) {
		DBMMessageDialog.showConfirmDialog("SCHEMA_FUNCTION_DROP");
