...
public class ScriptTriggerCreateAction extends DBMBaseAction {

	public ScriptTriggerCreateAction() {
		super("SCRIPT_TRIGGER_CREATE");
		// TODO 自动生成构造函数存根
	}

	@Override
	public void processAction(DBMFrame frame, ActionEvent actionEvent) {
		DBMMessageDialog.showConfirmDialog("SCRIPT_TRIGGER_CREATE");
