...
public class ScriptProcedureDropAction extends DBMBaseAction {

	public ScriptProcedureDropAction() {
		super("SCRIPT_PROCEDURE_DROP");
		// TODO 自动生成构造函数存根
	}

	@Override
	public void processAction(DBMFrame frame, ActionEvent actionEvent) {
		DBMMessageDialog.showConfirmDialog("SCRIPT_PROCEDURE_DROP");
