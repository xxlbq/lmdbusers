...
public class ScriptFunctionDropAction extends DBMBaseAction {

	public ScriptFunctionDropAction() {
		super("SCRIPT_FUNCTION_DROP");
		// TODO 自动生成构造函数存根
	}

	@Override
	public void processAction(DBMFrame frame, ActionEvent actionEvent) {
		DBMMessageDialog.showConfirmDialog("SCRIPT_FUNCTION_DROP");
