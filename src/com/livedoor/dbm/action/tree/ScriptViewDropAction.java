...
public class ScriptViewDropAction extends DBMBaseAction {

	public ScriptViewDropAction() {
		super("SCRIPT_VIEW_DROP");
		// TODO 自动生成构造函数存根
	}

	@Override
	public void processAction(DBMFrame frame, ActionEvent actionEvent) {
		DBMMessageDialog.showConfirmDialog("SCRIPT_VIEW_DROP");
