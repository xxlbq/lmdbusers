...
public class SchemaFunctionPropertiesAction extends DBMBaseAction {

	public SchemaFunctionPropertiesAction() {
		super("SCHEMA_FUNCTION_PROPERTIES");
		// TODO 自动生成构造函数存根
	}

	@Override
	public void processAction(DBMFrame frame, ActionEvent actionEvent) {
		DBMMessageDialog.showConfirmDialog("SCHEMA_FUNCTION_PROPERTIES");
