...
public class SchemaProcedureNewAction extends DBMBaseAction {

	public SchemaProcedureNewAction() {
		super("SCHEMA_PROCEDURE_NEW");
		// TODO 自动生成构造函数存根
	}

	@Override
	public void processAction(DBMFrame frame, ActionEvent actionEvent) {
		DBMMessageDialog.showConfirmDialog("SCHEMA_PROCEDURE_NEW");
