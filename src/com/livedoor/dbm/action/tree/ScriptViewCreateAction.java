...
public class ScriptViewCreateAction extends DBMBaseAction {

	public ScriptViewCreateAction() {
		super("SCRIPT_VIEW_CREATE");
		// TODO 自动生成构造函数存根
	}

	@Override
	public void processAction(DBMFrame frame, ActionEvent actionEvent) {
		DBMMessageDialog.showConfirmDialog("SCRIPT_VIEW_CREATE");
