...
public class ScriptTableAlterAction extends ScriptBaseAction {

	public ScriptTableAlterAction() {
		super("SCRIPT_TABLE_ALTER");
		// TODO 自动生成构造函数存根
	}
	...
	public String generateSqlScript(ConnectionInfo connInfo, DBMTreeNode currentNode, DBSession dbSession) {
		...
		//得到脚本语句
		return SqlBuilderFactory.createSqlBuilder(connInfo, dbSession,dateMetaInfo).alterTable();
