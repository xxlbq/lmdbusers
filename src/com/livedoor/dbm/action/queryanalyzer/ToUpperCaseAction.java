/**
 * $Id: ToUpperCaseAction.java,v 1.2 2006/12/04 02:55:13 lijc Exp $
 * 查询分析器工具栏按钮对应
 */
 ...
 * @version 1.0
 */
public class ToUpperCaseAction extends DBMBaseAction {
	private static final String ACTION_NAME = "TOUPPER";
