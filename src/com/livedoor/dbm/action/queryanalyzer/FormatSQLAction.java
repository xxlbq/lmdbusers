/**
 * $Id: FormatSQLAction.java,v 1.3 2006/12/04 02:55:13 lijc Exp $
 * 查询分析器工具栏按钮对应
 */
...
import com.livedoor.dbm.components.queryanalyzer.util.SQLFormatter;
import com.livedoor.dbm.util.StringUtil;

/**
 * <p>Title: 格式化</p> 
 * <p>Description: 格式化查询分析器中SQL语句</p> 
 ...
 * @version 1.0
 */
public class FormatSQLAction extends DBMBaseAction {
	private static final String ACTION_NAME = "FORMAT";
	...
	public void processAction(DBMFrame frame, ActionEvent actionEvent) {
		...
		if(StringUtil.isEmpty(script)) {
			...
			queryPanel.setScript(formatter.format(script));
		} else {
			queryPanel.replaceSelection(formatter.format(script));
		}
	}
