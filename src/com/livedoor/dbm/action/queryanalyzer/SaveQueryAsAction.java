/**
 * $Id: SaveQueryAsAction.java,v 1.2 2006/12/04 02:55:13 lijc Exp $
 * 查询分析器工具栏按钮对应
 */
 ...
 * @version 1.0
 */
public class SaveQueryAsAction extends DBMBaseAction {

	public static final String ACTION_NAME = "SAVE_QUERY_AS";

	public SaveQueryAsAction() {
		super(ACTION_NAME);
	}
