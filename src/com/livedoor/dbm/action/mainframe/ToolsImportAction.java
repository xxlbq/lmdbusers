...
import com.livedoor.dbm.components.mainframe.importexport.ImportFrame;
 ...
 * @version 1.0
 */
public class ToolsImportAction extends DBMBaseAction {

	public ToolsImportAction() {
		super("TOOLS_IMPORT");
	}
	...
	public void processAction(DBMFrame frame, ActionEvent actionEvent) {
		...
		ImportFrame imframe = new ImportFrame(connInfo, currentNode.getDBSession(), databaseName, schemaName, tableName);
