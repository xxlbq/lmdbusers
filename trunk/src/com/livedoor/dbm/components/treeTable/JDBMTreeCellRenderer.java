 ...
 * @version 1.0
 */
public final class JDBMTreeCellRenderer extends JLabel implements TreeCellRenderer {
	...
	public Component getTreeCellRendererComponent(JTree jtree, Object obj, boolean flag, boolean flag1, boolean flag2, int i, boolean flag3) {
		...
		setText(s);
		setToolTipText(s);
		DataNode dbmtreenode = null;
		try {
			dbmtreenode = (DataNode) obj;
