...
public class SchemaViewPropertiesAction extends DBMBaseAction {

	public SchemaViewPropertiesAction() {
		super("SCHEMA_VIEW_PROPERTIES");
		// TODO 自动生成构造函数存根
	}

	@Override
	public void processAction(DBMFrame frame, ActionEvent actionEvent) {
		DBMMessageDialog.showConfirmDialog("SCHEMA_VIEW_PROPERTIES");
