...
public class SchemaTablePropertiesAction extends DBMBaseAction {

	public SchemaTablePropertiesAction() {
		super("SCHEMA_TABLE_PROPERTIES");
		// TODO 自动生成构造函数存根
	}

	@Override
	public void processAction(DBMFrame frame, ActionEvent actionEvent) {
		DBMMessageDialog.showConfirmDialog("SCHEMA_TABLE_PROPERTIES");
