...
public class ScriptTableSelectAllAction extends ScriptBaseAction {

	public ScriptTableSelectAllAction() {
		super("SCRIPT_TABLE_SELECT_ALL");
		// TODO 自动生成构造函数存根
	}
	...
	public String generateSqlScript(ConnectionInfo connInfo, DBMTreeNode currentNode, DBSession dbSession) {
		...
		//得到脚本语句
		return SqlBuilderFactory.createSqlBuilder(connInfo, dbSession,dateMetaInfo).selectAll();
	}
