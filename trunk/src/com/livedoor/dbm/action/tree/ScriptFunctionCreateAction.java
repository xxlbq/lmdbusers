...
public class ScriptFunctionCreateAction extends DBMBaseAction {

	public ScriptFunctionCreateAction() {
		super("SCRIPT_FUNCTION_CREATE");
		// TODO 自动生成构造函数存根
	}

	@Override
	public void processAction(DBMFrame frame, ActionEvent actionEvent) {
		DBMMessageDialog.showConfirmDialog("SCRIPT_FUNCTION_CREATE");
