...
public class ScriptViewSelectAction extends DBMBaseAction {

	public ScriptViewSelectAction() {
		super("SCRIPT_VIEW_SELECT");
		// TODO 自动生成构造函数存根
	}

	@Override
	public void processAction(DBMFrame frame, ActionEvent actionEvent) {
		DBMMessageDialog.showConfirmDialog("SCRIPT_VIEW_SELECT");
