...
public class ScriptTriggerDropAction extends DBMBaseAction {

	public ScriptTriggerDropAction() {
		super("SCRIPT_TRIGGER_DROP");
		// TODO 自动生成构造函数存根
	}

	@Override
	public void processAction(DBMFrame frame, ActionEvent actionEvent) {
		DBMMessageDialog.showConfirmDialog("SCRIPT_TRIGGER_DROP");
