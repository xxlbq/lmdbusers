/**
 * $Id: NewQueryAction.java,v 1.3 2006/12/04 02:55:13 lijc Exp $
 * 查询分析器工具栏按钮对应
 */
 ...
 * @version 1.0
 */
public class NewQueryAction extends DBMBaseAction {

	private final static String ACTION_NAME = "NEW_QUERY";
